...
//        Setting up ViewPager, Adapter, and TabLayout
        ...
        tvAppend(sconsole, "Console Start\n");
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            MainTab.setSpeedometer(String.valueOf(TeensyMsg.ADD.SPEED.getValue()));
...
//                            SecondaryTab.setDCBusCurrent(DCbc);
    ...
    UsbSerialInterface.UsbReadCallback mCallback = new UsbSerialInterface.UsbReadCallback() {
        ...
        public void onReceivedData(byte[] arg0) {
            ...
            tvAppend(sconsole, TeensyMsg.hexStr(arg0) + "\n");
