...
public class SecondaryTab extends Fragment {
    private TextView DCBusVoltage, BMSCurr, batTemp, bmsVolt, dischargeLimit, chargeLimit;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        DCBusVoltage = rootView.findViewById(R.id.Value4);
        dischargeLimit = rootView.findViewById(R.id.Value5);

        return rootView;
    }

    public void setValues(long bmsVolt, long batTemp, long chargeLimit, long BMSCurr, long DCBusVoltage, long dischargeLimit) {
        ...
        this.DCBusVoltage.setText(String.valueOf(DCBusVoltage));
